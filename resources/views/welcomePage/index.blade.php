        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn"
            ...
            <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
                <div class="navbar-nav ms-auto">
                    ...
                    <a href="{{ route('ticket') }}" class="nav-item nav-link">Check Ticket</a>
                </div>
                <a href="{{ route('booking-form') }}" class="btn btn-primary">Buy Ticket<i
                    ...
                    <div class="col-lg-6">
                        <div class="bg-primary h-100 d-flex align-items-center py-4 px-4 px-sm-5">
                            ...
                            <div class="ms-4">
                                ...
                                <h2 class="text-white mb-0">+97876787689</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2">
                            <i class="fa fa-map-marker-alt me-3"></i>123 Street, kerala
                        </p>
                        <p class="mb-2">
                            <i class="fa fa-phone-alt me-3"></i>0090009900
                        </p>
                        <p class="mb-2">
                            <i class="fa fa-envelope me-3"></i>sr.dev.akshay@gmail.com
                        </p>
                        <div class="d-flex pt-2">
                            ...
                            <a class="btn btn-outline-light btn-social"  href="https://www.linkedin.com/in/akshay-p-734158191" target="_blank"><i
                                    class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
